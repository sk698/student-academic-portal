  ...
  return (
    <>
      <header className="mb-8">
        <h1 className="font-headline text-4xl font-extrabold tracking-tight text-primary">Welcome back, Julian</h1>
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-12">
        <BentoBox className="group relative overflow-hidden md:col-span-4 lg:col-span-3">
          ...
          <h2 className="mt-2 font-headline text-6xl font-black tracking-tight text-primary">{dashboardStats[0].value}</h2>
          <p className="mt-6 flex items-center gap-2 text-sm font-bold text-emerald-600">
            <span className="material-symbols-outlined text-base">trending_up</span>
            {dashboardStats[0].trend}
          </p>
        </BentoBox>
        ...
        <BentoBox className="overflow-hidden bg-gradient-to-br from-primary to-primary-container text-white md:col-span-12 lg:col-span-6">
          ...
          <div className="mt-3 flex flex-wrap items-end justify-between gap-6">
            <div>
              <p className="font-headline text-5xl font-black tracking-tight">{dashboardStats[2].value}</p>
              <p className="text-sm text-blue-100">Credits Earned</p>
            </div>
            <div>
              <p className="font-headline text-4xl font-black tracking-tight">{dashboardStats[1].value}</p>
